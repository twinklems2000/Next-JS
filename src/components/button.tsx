...
export default function Button({ title, type, handleClick, isLoading }: any) {
  return (
    <>
      {isLoading ? (
        <div className="my-4 rounded-lg flex flex-row justify-center">
          <div role="status">
            <svg
              aria-hidden="true"
              className="w-10 h-8 text-violet-200 animate-spin dark:text-violet-800 fill-violet-800"
              viewBox="0 0 100 101"
              fill="none"
